...
icon("brush", "tools", ["paint", "bristle", "draw", "round brush"],
     ...
     f=[poly([(-2.2, -2.3), (3.2, -1.8), (9, 0), (3.2, 1.8), (-2.2, 2.3)], close=True, t=T)],
     apps="PS/AI/PR",
...
icon("airbrush", "tools", ["spray", "atomiser", "soft", "mist"],
     s=[rect(-9, -2.4, 7.0, 4.8, t=T),
        circle(1.4, -2.8, 1.3, t=T), circle(2.2, 2.6, 1.3, t=T)],
     f=[dot(6.8, 0, 1.3, t=T)],
     apps="PS/PR",
...
icon("pen-ink", "tools", ["nib", "dip pen", "ink", "line art"],
     s=[line(-9, 0, -2.6, 0, t=T),
        poly([(-2.6, -2.6), (9, 0), (-2.6, 2.6)], close=True, t=T),
        line(0.4, 0, 5.6, 0, t=T)],
     f=[poly([(5.9, -0.82), (9, 0), (5.9, 0.82)], close=True, t=T)],
     apps="PS/AI/PR",
...
icon("calligraphy", "tools", ["broad edge", "lettering", "italic nib"],
     s=[line(-9, 0, -1.4, 0, t=T), rect(-1.4, -2.4, 5.4, 4.8, 0.7, t=T)],
     f=[poly([(4.0, -3.6), (9, -1.2), (9, 1.2), (4.0, 3.6)], close=True, t=T)],
     apps="PS/AI/PR",
...
icon("crayon", "tools", ["wax", "kids", "stub"],
     s=[poly([(-6.6, -2.5), (3.2, -2.5), (3.2, 2.5), (-6.6, 2.5)], close=True, t=T),
        line(-3.4, -2.5, -3.4, 2.5, t=T), line(-0.6, -2.5, -0.6, 2.5, t=T)],
...
icon("chalk", "tools", ["pastel", "dry media", "stick"],
     s=[poly([(-7.6, -2.6), (2.6, -2.6), (2.6, 2.6), (-7.6, 2.6)], close=True, t=T),
        seq(line(8.4, -3.2, 9.4, -3.9, t=T), line(8.8, 2.2, 9.9, 2.8, t=T))],
...
icon("oil-brush", "tools", ["flat brush", "bristle", "impasto"],
     s=[line(-9, 0, -2.6, 0, t=T),
        line(0.4, -3.0, 0.4, 3.0, t=T),
        line(1.8, -2.6, 8.4, -2.6, t=T), line(1.8, 0, 8.4, 0, t=T),
        line(1.8, 2.6, 8.4, 2.6, t=T)],
...
icon("spray-can", "tools", ["aerosol", "graffiti", "rattle can"],
     s=[rect(6.4, 8.2, 8.2, 12.6),
        rect(8.0, 4.6, 5.0, 3.6),
        line(13.0, 6.4, 15.2, 6.4),
        seq(line(16.8, 8.0, 19.6, 9.2), line(17.2, 3.4, 19.2, 2.2))],
     f=[dot(18.6, 5.4, 1.4)],
     apps="PR",
...
icon("stamp", "tools", ["clone", "rubber stamp", "duplicate source"],
     s=[poly([(9.2, 3.6), (14.8, 3.6), (16.0, 10.4), (8.0, 10.4)], close=True),
        rect(5.8, 12.6, 12.4, 3.6, 0.9),
        line(7.8, 16.2, 7.8, 19.0), line(16.2, 16.2, 16.2, 19.0)],
     f=[taper(5.8, 20.4, 18.2, 20.4, 1.9, 1.9)],
     apps="PS",
...
icon("stamp-pattern", "tools", ["pattern stamp", "tile", "repeat"],
     s=[poly([(9.2, 3.4), (14.8, 3.4), (16.0, 10.0), (8.0, 10.0)], close=True),
        rect(5.8, 12.2, 12.4, 3.4),
        rect(5.8, 17.2, 12.4, 3.6)],
     f=[seq(rect(5.8, 17.2, 6.2, 1.8), rect(12.0, 19.0, 6.2, 1.8))],
     apps="PS",
...
icon("eraser", "tools", ["rub out", "delete", "undo mark"],
     s=[rect(5.4, 7.4, 13.2, 9.2), line(5.4, 11.6, 18.6, 11.6)],
     f=[rect(5.4, 11.6, 13.2, 5.0)],
     apps="PS/AI/PR",
...
icon("eraser-hard", "tools", ["hard edge", "crisp", "block"],
     s=[rect(5.4, 7.4, 13.2, 9.2), line(19.6, 6.2, 19.6, 18.6)],
     f=[rect(5.4, 11.6, 13.2, 5.0)],
     apps="PS/PR",
...
icon("eraser-soft", "tools", ["feather", "soft edge", "fade"],
     s=[rect(5.4, 7.4, 13.2, 9.2),
        seq(line(19.6, 6.2, 19.6, 9.0), line(19.6, 10.4, 19.6, 12.6), line(19.6, 14.0, 19.6, 18.6))],
     f=[rect(5.4, 11.6, 13.2, 5.0)],
     apps="PS/PR",
...
icon("smudge", "tools", ["finger", "drag", "blend"],
     ...
     f=[poly([(-0.4, -2.8), (5.0, -1.4), (8.6, 0), (5.0, 1.4), (-0.4, 2.8)], close=True, t=T)],
     apps="PS/PR",
...
icon("sharpen", "tools", ["crisp", "detail", "cone"],
     s=[poly([(12, 3.2), (17.6, 18.2), (6.4, 18.2)], close=True),
        line(6.4, 14.4, 17.6, 14.4)],
     f=[poly([(12, 3.2), (14.2, 9.0), (9.8, 9.0)], close=True)],
     apps="PS/AI/PR",
...
icon("dodge", "tools", ["lighten", "hold back", "darkroom"],
     s=[line(13.2, 11.8, 19.6, 20.4)],
     f=[circle(10.0, 8.6, 5.2)],
     apps="PS",
...
icon("sponge", "tools", ["saturation", "soak", "porous"],
     s=[smooth([(4.0, 9.0), (12.0, 4.6), (19.6, 9.6), (16.4, 18.0), (6.4, 17.2)], close=True),
        circle(9.4, 10.6, 1.9)],
     f=[dot(15.4, 14.0, 1.7)],
     apps="PS",
...
icon("heal-spot", "tools", ["blemish", "spot removal", "target"],
     s=[circle(12, 12, 6.6), circle(12, 12, 2.6),
        seq(line(12, 2.6, 12, 4.6), line(12, 19.4, 12, 21.4),
...
icon("patch", "tools", ["region repair", "graft", "swap"],
     s=[smooth([(4.2, 9.0), (8.4, 4.4), (13.0, 7.4), (9.4, 12.0), (4.6, 11.4)], close=True),
        rect(12.6, 12.6, 7.4, 7.4)],
     f=[tip(12.0, 12.0, 2.8, 45)],
     apps="PS",
...
icon("eyedropper", "tools", ["picker", "sample", "colour pick"],
     s=[line(-9, 0, -3.4, 0, t=T), line(-4.4, -2.3, -1.4, 0.7, t=T),
        poly([(-2.4, -2.0), (5.6, -1.1), (5.6, 1.1), (-2.4, 2.0)], close=True, t=T)],
     f=[poly([(5.6, -1.1), (9, 0), (5.6, 1.1)], close=True, t=T)],
     apps="PS/AI/PR",
...
icon("brush-flow", "tools", ["rate", "load", "delivery"],
     s=[poly([(8.6, 3.2), (15.4, 3.2), (13.8, 6.8), (10.2, 6.8)], close=True),
        circle(12, 10.2, 1.3), circle(12, 14.2, 1.9)],
     f=[dot(12, 19.0, 2.6)],
     apps="PS/PR",
...
icon("brush-hardness", "tools", ["edge", "falloff", "core"],
     s=[circle(12, 12, 8.4),
        seq(*[arc(12, 12, 5.6, a, a + 34) for a in (0, 90, 180, 270)])],
     f=[dot(12, 12, 3.2)],
     apps="PS/AI/PR",
...
icon("brush-roundness", "tools", ["flatten", "squash", "ellipse nib"],
     s=[circle(12, 12, 8.4), seq(line(3.6, 12, 6.0, 12), line(18.0, 12, 20.4, 12))],
     f=[ellipse(12, 12, 6.0, 3.0)],
     apps="PS/AI/PR",
...
icon("brush-wet", "tools", ["wet mix", "dilute", "bleed"],
     s=[circle(12, 13.4, 6.6),
        seq(line(12, 3.0, 14.3, 6.1), arc(12, 7.6, 2.9, 316, 584), line(9.7, 6.1, 12, 3.0))],
     f=[],
     apps="PS/PR",
...
icon("brush-buildup", "tools", ["accumulate", "density", "layering"],
     s=[rect(4.4, 3.4, 15.2, 17.2)],
     f=[seq(rect(4.4, 15.4, 15.2, 5.2), rect(4.4, 10.2, 15.2, 3.6), rect(4.4, 6.0, 15.2, 2.6))],
     apps="PS/PR",
...
icon("streamline", "tools", ["stabiliser", "smoothing", "steady"],
     s=[poly([(3.0, 8.0), (6.0, 3.8), (9.0, 10.0), (12.0, 4.2), (15.0, 9.6), (18.0, 4.4),
              (21.0, 7.6)]),
        smooth([(3.0, 17.6), (7.5, 14.8), (12.0, 17.6), (16.5, 14.8), (21.0, 17.6)])],
     f=[],
     apps="PR",
...
icon("quickshape", "tools", ["snap to shape", "clean up", "auto shape"],
     s=[arc(12, 12, 8.0, -90, 90),
        poly([(12, 20.0), (5.4, 19.6), (3.2, 13.0), (5.6, 6.2), (12, 4.0)])],
     f=[dot(12, 4.0, 1.3)],
     apps="PR",
...
icon("symmetry-quadrant", "tools", ["four way", "kaleidoscope"],
     s=[seq(line(12, 2.6, 12, 21.4), line(2.6, 12, 21.4, 12)),
        poly([(9.6, 9.6), (4.8, 9.6), (9.6, 4.8)], close=True),
        poly([(14.4, 9.6), (19.2, 9.6), (14.4, 4.8)], close=True),
        poly([(9.6, 14.4), (4.8, 14.4), (9.6, 19.2)], close=True)],
     f=[poly([(14.4, 14.4), (19.2, 14.4), (14.4, 19.2)], close=True)],
     apps="PR",
...
icon("symmetry-radial", "tools", ["rotational", "mandala", "spokes"],
     s=[circle(12, 12, 8.6),
        seq(line(12, 3.4, 12, 20.6), line(4.6, 7.7, 19.4, 16.3), line(4.6, 16.3, 19.4, 7.7))],
     f=[dot(16.0, 6.0, 1.3)],
     apps="PR",
