...
icon("document-save-as", "document", ["save copy", "duplicate file"],
     s=[rect(4.0, 4.0, 16.0, 16.0), rect(7.4, 4.0, 6.0, 5.0),
        seq(line(15.4, 17.4, 15.4, 20.6), line(13.8, 19.0, 17.0, 19.0))],
     f=[],
     apps="PS/AI",
...
icon("document-close", "document", ["close file"],
     s=[poly([(5.4, 3.4), (14.6, 3.4), (18.6, 7.4), (18.6, 20.6), (5.4, 20.6)], close=True),
        line(14.6, 3.4, 14.6, 7.4), line(14.6, 7.4, 18.6, 7.4)],
     f=[tip(19.6, 20.6, 2.2, 45)],
     apps="PS/AI/PR",
     basis="The document page, with the corner tucked away as it closes.",
     note="A page with its own corner folding shut.")

icon("document-revert", "document", ["revert to saved", "discard changes"],
     s=[rect(4.0, 4.0, 16.0, 16.0), rect(7.4, 4.0, 6.0, 5.0), arc(12, 16.0, 4.2, 40, 320)],
     f=[tip(8.35, 12.75, 1.9, 220)],
     apps="PS",
...
icon("canvas-size", "document", ["resize canvas", "expand document"],
     s=[rect(7.0, 7.0, 10.0, 10.0), rect(3.4, 3.4, 17.2, 17.2)],
     f=[],
     apps="PS",
...
icon("resample", "document", ["interpolation", "pixel resample"],
     ...
     f=[seq(rect(3.4, 8.0, 6.0, 3.0), rect(9.0, 8.0, 6.0, 3.0), rect(14.6, 8.0, 6.0, 3.0))],
     apps="PS",
...
icon("zoom-fit", "document", ["fit to screen", "fit window"],
     s=[rect(5.4, 5.4, 13.2, 13.2),
        seq(poly([(3.4, 7.4), (3.4, 3.4), (7.4, 3.4)]), poly([(16.6, 3.4), (20.6, 3.4), (20.6, 7.4)]),
...
icon("pan-hand", "document", ["hand tool", "scroll canvas"],
     s=[poly([(7.0, 20.6), (5.4, 13.0), (5.4, 9.0), (7.0, 9.0), (7.0, 6.0), (8.6, 6.0),
              (8.6, 5.0), (10.2, 5.0), (10.2, 4.4), (11.8, 4.4), (11.8, 9.6), (13.4, 9.6),
              (16.6, 13.0), (16.6, 20.6)], close=True)],
     f=[],
     apps="PS/AI/PR",
...
icon("view-actual-colors", "document", ["proof colours", "soft proof"],
     s=[circle(9.0, 9.0, 5.0), circle(15.0, 15.0, 5.0)],
     f=[],
     apps="PS",
