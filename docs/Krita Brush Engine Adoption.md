...
7. **Next:** move the correct CPU implementation to a persistent GPU read/modify/write path.
8. **Next:** benchmark local/tiled Vulkan strategies on actual Adreno and Mali devices before selecting an optimization.
