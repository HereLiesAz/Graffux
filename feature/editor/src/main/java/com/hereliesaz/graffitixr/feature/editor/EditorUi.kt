...
// LayersPanel used to live here — replaced by relocatable ("reloc") sub-items directly in the
// AzNavRail's "Layers" host (see MainActivity.ConfigureRailItems), each showing the layer's own
// bitmap as its rail content and driving canvas z-order via drag-to-reorder.
